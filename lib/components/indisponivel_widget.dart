...
class IndisponivelWidget extends StatefulWidget {
  const IndisponivelWidget({Key? key}) : super(key: key);

  @override
  _IndisponivelWidgetState createState() => _IndisponivelWidgetState();
}
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    'Em breve novos estabelecimentos estarão presente',
                    textAlign: TextAlign.center,
