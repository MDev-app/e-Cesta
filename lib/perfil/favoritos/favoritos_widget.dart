              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      StreamBuilder<List<MenuProdutosRecord>>(
                        stream: queryMenuProdutosRecord(
                          queryBuilder: (menuProdutosRecord) =>
                              menuProdutosRecord.where('favorito_users',
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<MenuProdutosRecord>
                              columnMenuProdutosRecordList = snapshot.data!;
                          return SingleChildScrollView(
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: List.generate(
                                  columnMenuProdutosRecordList.length,
                                  (columnIndex) {
                                final columnMenuProdutosRecord =
                                    columnMenuProdutosRecordList[columnIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 8.0),
                                  child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  ToggleIcon(
                                                    onPressed: () async {
                                                      ...
                                                      await columnMenuProdutosRecord
                                                          .reference
                                                          .update(
                                                              menuProdutosUpdateData);
                                                    },
                                                    value: columnMenuProdutosRecord
                                                        .favoritoUsers!
                                                        .toList()
                                                        .contains(
                                                            currentUserReference),
