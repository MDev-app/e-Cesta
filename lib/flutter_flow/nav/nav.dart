          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ...
                  : InicioWidget(
                      cidade: params.getParam('cidade', ParamType.String),
                    ),
            ),
            FFRoute(
              name: 'BoasVindas2',
              path: 'boasVindas2',
              builder: (context, params) => BoasVindas2Widget(),
            ),
            FFRoute(
              name: 'Login',
              path: 'login',
            ...
            FFRoute(
              name: 'HomeNegocio',
              path: 'homeNegocio',
              builder: (context, params) => HomeNegocioWidget(
                idNegocio: params.getParam('idNegocio', ParamType.int),
              ),
            ),
            FFRoute(
              ...
              builder: (context, params) => DetalhesProdutosWidget(
                refProduto: params.getParam('refProduto',
                    ParamType.DocumentReference, false, ['menu_produtos']),
              ),
            ),
            FFRoute(
              name: 'Carrinho',
            ...
            FFRoute(
              ...
              builder: (context, params) => EditarPerfilWidget(
                ...
                sobrenome: params.getParam('sobrenome', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'Configuracao',
            ...
            FFRoute(
              name: 'CarrinhoGeral',
              path: 'carrinhoGeral',
              builder: (context, params) => CarrinhoGeralWidget(
                idNegocio: params.getParam('idNegocio', ParamType.int),
              ),
            ),
            FFRoute(
